...
<head>
    ...
    <style>
        ...
        .update-badge { background: #e2e3f0; color: #6f42c1; padding: 10px 15px; border-radius: 6px; text-align: center; margin: 20px 0; border: 1px solid #c5c8d6; }
        ...
        .changes-section { background: #f8f9ff; padding: 20px; border-radius: 8px; border: 1px solid #e7ecff; margin: 20px 0; }
        .change-item { background: white; padding: 12px; margin: 8px 0; border-radius: 4px; border-left: 4px solid #6f42c1; }
        h1 { margin: 0; font-size: 28px; font-weight: 300; }
        h2 { color: #6f42c1; margin-top: 0; }
        .ticket-id { background: #e2e3f0; padding: 10px; border-radius: 6px; text-align: center; font-family: monospace; font-size: 18px; font-weight: bold; color: #6f42c1; margin: 20px 0; }
        .button { display: inline-block; background: #6f42c1; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin: 10px 5px; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="update-badge">
                🔄 Your issue has been updated by our team
            </div>
            ...
            <div style="background: #d4edda; color: #155724; padding: 15px; border-radius: 6px; margin: 20px 0; border: 1px solid #c3e6cb; text-align: center;">
                <strong>🎉 Great News!</strong> Your issue has been resolved. If you're still experiencing problems, please let us know by replying to this email.
            </div>
            ...
            <div style="background: #fff3cd; color: #856404; padding: 15px; border-radius: 6px; margin: 20px 0; border: 1px solid #ffeaa7; text-align: center;">
                <strong>🔧 Work in Progress</strong> Our team is actively working on resolving your issue. We'll keep you updated on our progress.
            </div>
            @endif
            
            <div style="text-align: center; margin: 30px 0;">
                <a href="{{ config('app.url') }}/issues/{{ $issueId }}" class="button">View Issue Details</a>
            </div>
            
            <p><strong>Need assistance?</strong> If you have questions about this update or need to provide additional information, simply reply to this email with your Issue ID (#{{ $issueId }}).</p>
        ...
        <div class="footer">
            ...
            <p><strong>Issue ID:</strong> #{{ $issueId }} | Updated {{ \Carbon\Carbon::parse($updatedAt)->format('M j, Y g:i A') }}</p>
        </div>
    </div>
</body>
</html>